...
import { InactivationInspectionStatusInterface, RecategorizedInspectionStatusInterface, ReclassifiedInspectionStatusInterface, RegistrationInspectionStatusInterface, TemporarySuspensionInspectionStatusInterface } from '../interfaces/inspection-status.interface';
...
export class InspectionStatusService {
    ...
    createRegistrationInspectionStatus(payload:RegistrationInspectionStatusInterface) {
