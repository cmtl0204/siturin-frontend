import { CatalogueTouristTransportClassificationsCodeEnum } from '../../enum';
import { HeaderRegulation, Item } from '../../models/item.interface';

export const data: HeaderRegulation[] = [
    {
        // classification: 'Transporte Turistico',
        definition:
        ...
        codeClassification: CatalogueTouristTransportClassificationsCodeEnum.tourist_air_transport
    },
    {
        // classification: 'Transporte Turistico',
        definition:
        ...
        codeClassification: CatalogueTouristTransportClassificationsCodeEnum.tourist_maritime_transport
    },
    {
        // classification: 'Transporte Turistico',
        definition:
        ...
        codeClassification: CatalogueTouristTransportClassificationsCodeEnum.tourist_land_transport
    }
];
